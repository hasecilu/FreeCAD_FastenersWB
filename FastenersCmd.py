...
FSScrewCommandTable = {
    ...
    "ISO7049-C": (translate("FastenerCmd", "ISO 7049 Pan head self tapping screws with conical point, type H cross r."), HCrossGroup, ScrewParametersLC, "ISO"),
    "ISO7049-F": (translate("FastenerCmd", "ISO 7049 Pan head self tapping screws with flat point, type H cross r."), HCrossGroup, ScrewParametersLC, "ISO"),
    "ISO7049-R": (translate("FastenerCmd", "ISO 7049 Pan head self tapping screws with rounded point type H cross r."), HCrossGroup, ScrewParametersLC, "ISO"),
